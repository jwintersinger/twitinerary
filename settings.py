...
MEDIA_VERSION = 1 # Not used by me, but value must be provided.
...
SECRET_KEY = 'I am a happy key. I do key-like things with my time. I may even be sentient.'
...
MIDDLEWARE_CLASSES = (
    ...
    'twitinerary.middleware.UserMiddleware',
)
